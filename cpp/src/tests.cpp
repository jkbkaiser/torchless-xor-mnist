...
//     Tensor g = c + f;
//
//     Tensor h = Tensor::from_vec(std::vector<std::vector<double>>{
//         {7.0, 8.0, 9.0, 10.0},
//         {3.0, 4.0, 5.0, 6.0},
//     });
//
...
//     Linear l = Linear(2, 8);
//
//     l.weight = Tensor::from_vec(std::vector<std::vector<double>>{
...
//
//     Tensor expected_output = Tensor::from_vec(std::vector<double>{
...
//
// int test_relu() {
//     Tensor input = Tensor::from_vec(std::vector<double>{
//         -3.0,
//         4.0,
//         -1000.0,
//         0.0001,
